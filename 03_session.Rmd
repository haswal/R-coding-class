...
<!-- Both scripts from Session 03 are available for download below. -->
...
<!-- ```{r include = TRUE, echo = FALSE} -->
<!-- # a embed single file -->
<!-- xfun::embed_files(c("scripts/session_03_desiree.R", "scripts/Session_3_hasse.R"), -->
<!--                   text = paste("Download Session 3 scripts"), -->
<!--                   name = paste0("03_session", ".zip") -->
<!--                   ) -->
<!-- ``` -->
