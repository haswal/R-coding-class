---
title: "Sampling dist vs. sample size"
...
d1 <- tibble(values = c(mvrnorm(25, 2, 1, empirical = TRUE),
                        mvrnorm(25, 2.5, 1, empirical = TRUE)),
             group = rep(c("Ctrl", "Drug"), each = 25))

d2 <- tibble(values = c(mvrnorm(250, 2, 1, empirical = TRUE),
                        mvrnorm(250, 2.5, 1, empirical = TRUE)),
             group = rep(c("Ctrl", "Drug"), each = 250))

d3 <- tibble(values = c(mvrnorm(2500, 2, 1, empirical = TRUE),
                        mvrnorm(2500, 2.5, 1, empirical = TRUE)),
             group = rep(c("Ctrl", "Drug"), each = 2500))
```
