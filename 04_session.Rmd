...
<!-- The script from Session 04 is available for download below. -->
...
<!-- ```{r include = TRUE, echo = FALSE} -->
<!-- # a embed single file -->
<!-- xfun::embed_files(c("scripts/session_04_desiree.R", "scripts/Session_4_hasse.R"),  -->
<!--                   text = paste("Download Session 4 scripts"),  -->
<!--                   name = paste0("04_session", ".zip") -->
<!--                   ) -->
<!-- ``` -->
